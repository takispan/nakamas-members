...
<div class="ds-single-dancer">
  ...
  <button id="change-dancer-status" class="button" data-dancer-id="<?php echo $dancer->ID; ?>">Change Status</button>
  <button id="remove-dancer-from-dancers-list" class="button" data-ds-id="<?php echo $dance_school_id; ?>" data-dancer-id="<?php echo $dancer->ID; ?>">Remove Dancer</button>
</div><!-- .nkms-tabs -->
